...
namespace Agence_Practical_Test.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult _Con_desempenho(List<string> coUsuario, string initDate, string finalDate)
        {
            ...
            var body2 = JsonConvert.SerializeObject(new { month = new System.Globalization.CultureInfo("pt-BR").DateTimeFormat.AbbreviatedMonthNames.ToList().IndexOf(initDate.Split("/")[0].ToLower()+"."), list = new System.Globalization.CultureInfo("pt-BR").DateTimeFormat.AbbreviatedMonthNames.ToList(), parsed= DateTime.TryParse($"1/{new System.Globalization.CultureInfo("pt-BR").DateTimeFormat.AbbreviatedMonthNames.ToList().IndexOf(initDate.Split("/")[0].ToLower() + ".")-1}/{initDate.Split(" / ")[1]}", out _) });
            ...
            var parsed = DateTime.TryParse($"1/{new System.Globalization.CultureInfo("pt-BR").DateTimeFormat.AbbreviatedMonthNames.ToList().IndexOf(initDate.Split("/")[0].ToLower() + ".")-1}/{initDate.Split(" / ")[1]}", out initialD);
            parsed = DateTime.TryParse($"1/{initDate.Split(" / ")[0]}/{new System.Globalization.CultureInfo("pt-BR").DateTimeFormat.AbbreviatedMonthNames.ToList().IndexOf(initDate.Split("/")[1].ToLower() + ".")-1}", out finalD);
